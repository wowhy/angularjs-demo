...
/***/ function(module, exports, __webpack_require__) {
	...
	var _module = angular.module('sample.admin', [_commonCore2['default'], _layout2['default'], _authorization2['default']]).constant('settings', _settings2['default']).config(_route2['default']).run(["$rootScope", "settings", function ($rootScope, settings) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = angular.module('sample.admin.authorization', ['sample.core']).config(_route2['default']).name;
	module.exports = exports['default'];
